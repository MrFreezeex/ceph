...
public:
  ...
  void expect_mirror_image_status_exists(bool exists, bool local_only) {
...
TEST_F(TestMockImageReplayer, StartStop) {
  ...
  expect_mirror_image_status_exists(false, false);
...
TEST_F(TestMockImageReplayer, LocalImagePrimary) {
  ...
  expect_mirror_image_status_exists(false, true);
